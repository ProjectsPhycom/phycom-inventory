<template>
  <div>
    <!-- Button actions -->
    <v-row align="right">
      <v-col cols="3" xs="12" sm="12" md="12" lg="3">
        <v-btn color="indigo" outlined class="ml-2">
          Confirmar préstamo
        </v-btn>
      </v-col>
      <v-col cols="3" xs="12" sm="12" md="12" lg="3">
        <v-btn outlined color="indigo" class="ml-2">
          Ver lista (5)
        </v-btn>
      </v-col>
      <v-col cols="3" xs="12" sm="12" md="12" lg="3">
        <v-btn text color="red" class="ml-2">
          Eliminar lista
        </v-btn>
      </v-col>
    </v-row>
    ...
    <div class="py-1">
      <v-row align="center">
        ...
        <v-col cols="12" sm="12" md="12" lg="8" class="py-3">
          <div class="flex flex-row">
            <v-text-field
              ...
              v-model="searchText"
            ></v-text-field>
            <v-btn icon color="indigo" @click="search()" class="my-auto ml-2">
          ...
          <v-list-item :key="'item-' + item.id">
            ...
            <v-list-item-content class="text-justify">
              ...
              <div class="flex flex-row justify-between w-full">
                <div class="my-auto w-2-3 subtitle">
                  {{ item.description }}
                </div>
